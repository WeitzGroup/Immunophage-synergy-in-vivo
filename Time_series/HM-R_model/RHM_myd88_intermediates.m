...
[y_100,  TB_100, time_100] = simRHM(Kis(1), Io, Bo, Po);
[y_70,  TB_70, time_70] = simRHM(Kis(2), Io, Bo, Po);
[y_50,  TB_50, time_50] = simRHM(Kis(3), Io, Bo, Po);
[y_20,  TB_20, time_20] = simRHM(Kis(4), Io, Bo, Po);
[y_10,  TB_10, time_10] = simRHM(Kis(5), Io, Bo, Po);
...
h_leg = legend(v, '10%', '20%','50%', '70%', '100%','Location','eastoutside');
axis([0,72,1e0,1e15])
legend boxoff
...
% saveas(gcf, '3_E_RHM_myd88_intermediates', 'fig')
% saveas(gcf,'3_E_RHM_myd88_intermediates','epsc')
