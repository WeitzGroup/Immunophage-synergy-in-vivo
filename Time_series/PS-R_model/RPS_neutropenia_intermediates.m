...
[y_100, TB_100, time_100] = simRPS(Kis(1), Is(1), Bo, Po);
[y_70, TB_70, time_70] = simRPS(Kis(2), Is(2), Bo, Po);
[y_50, TB_50, time_50] = simRPS(Kis(3), Is(3), Bo, Po);
[y_20, TB_20, time_20] = simRPS(Kis(4), Is(4), Bo, Po);
[y_10, TB_10, time_10] = simRPS(Kis(5), Is(5), Bo, Po);
[y_1, TB_1, time_1] = simRPS(Kis(6), Is(6), Bo, Po);
...
h_leg = legend(v, '1%','10%', '20%','50%', '70%', '100%','Location','east');
axis([0,144,1e0,1e15])
legend boxoff
...
%  saveas(gcf, 'B_RPS_neutropenia_intermediates', 'fig')
%  saveas(gcf,'B_RPS_neutropenia_intermediates','epsc')
