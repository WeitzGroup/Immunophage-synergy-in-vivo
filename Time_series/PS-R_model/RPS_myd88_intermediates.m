...
[y_100, TB_100, time_100] = simRPS(Kis(1), Io, Bo, Po);
[y_70, TB_70, time_70] = simRPS(Kis(2), Io, Bo, Po);
[y_50, TB_50, time_50] = simRPS(Kis(3), Io, Bo, Po);
[y_20, TB_20, time_20] = simRPS(Kis(4), Io, Bo, Po);
[y_10, TB_10, time_10] = simRPS(Kis(5), Io, Bo, Po);
...
h_leg = legend(v, '10%', '20%','50%', '70%', '100%','Location','east');
axis([0,144,1e0,1e15])
legend boxoff
...
%  saveas(gcf, 'A_RPS_myd88_intermediates', 'fig')
%  saveas(gcf,'A_RPS_myd88_intermediates','epsc')
