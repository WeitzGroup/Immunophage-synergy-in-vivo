% Code to simulate heterogeneous mixing model (ODE)
% Immunocompetent
% Phage added two hours after infection
% Dependencies: (1) hmODE.m (2) simHM_WT.m (3) myEventsFcn.m
...
% 
%  saveas(gcf, 'HM_immunocompetent', 'fig')
%  saveas(gcf,'HM_immunocompetent','epsc')