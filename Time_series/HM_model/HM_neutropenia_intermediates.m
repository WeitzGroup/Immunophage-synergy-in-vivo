...
[y_100, TB_100, time_100] = simHM(Kis(1), Is(1), Bo, Po);
[y_70, TB_70, time_70] = simHM(Kis(2), Is(2), Bo, Po);
[y_50, TB_50, time_50] = simHM(Kis(3), Is(3), Bo, Po);
[y_20, TB_20, time_20] = simHM(Kis(4), Is(4), Bo, Po);
[y_10, TB_10, time_10] = simHM(Kis(5), Is(5), Bo, Po);
...
h_leg = legend(v, '10%', '20%','50%', '70%', '100%','Location','north');
axis([0,144,1e0,1e15])
legend boxoff
...
%  saveas(gcf, 'HM_neutropenia_intermediates', 'fig')
%  saveas(gcf,'HM_neutropenia_intermediates','epsc')