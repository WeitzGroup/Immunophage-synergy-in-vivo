...
[y_100, TB_100, time_100] = simHM(Kis(1), Io, Bo, Po);
[y_70, TB_70, time_70] = simHM(Kis(2), Io, Bo, Po);
[y_50, TB_50, time_50] = simHM(Kis(3), Io, Bo, Po);
[y_20, TB_20, time_20] = simHM(Kis(4), Io, Bo, Po);
[y_10, TB_10, time_10] = simHM(Kis(5), Io, Bo, Po);
...
%  saveas(gcf, 'HM_myd88_intermediates', 'fig')
%  saveas(gcf,'HM_myd88_intermediates','epsc')
