...
% Setting plot format
    lwidth=3; lbsize=16;
    xticklabels=min(PC_range):0.5e7:max(PC_range);
    ...
    xlabel('$P_C$ (PFU/g)'); ylabel('$\phi$ [g/(h PFU)]');
